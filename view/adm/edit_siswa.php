<?php 
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="sekolah">Nama Karyawan:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <button type="button" onclick="hapusSiswa(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus Karyawan</button>
    </div>
  </div>
</form>
<?php
